...
public class InventoryTest {
    public static void main(String[] args) {
        ...
        GoldHelmet goldHelmet = new GoldHelmet("Gold Helmet", "A bost gold helmet.", 7, 40);
        DiamondHelmet diamondHelmet = new DiamondHelmet("Diamond Helmet", "A ultra rarity diamond helmet.", 15, 100);
        LeatherHelmet leatherHelmet = new LeatherHelmet("Leather Helmet", "A  special leather helmet.", 10, 70);
