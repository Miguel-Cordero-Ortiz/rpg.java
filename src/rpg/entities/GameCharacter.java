...
public class GameCharacter {
    ...
    /**
     * Realiza un ataque contra otro personaje del juego, calculando el daño en función del ataque del atacante y la defensa del enemigo.
     * Si el ataque es mayor que la defensa, el enemigo perderá HP, y el daño se muestra en una ventana emergente.
     *
